---
name: admin
description: Admin operations for the main channel — registering/managing groups (add, remove, list, sender allowlist, triggers), container mounts and paths, Anthropic authentication, cross-group scheduling, and task-script scheduling. Load this whenever the request involves managing groups, mounts, auth, or scheduling tasks.
---

# Admin Operations

Reference for main-channel admin work. This content used to live in `CLAUDE.md`; it was moved here so it loads on demand instead of on every run.
...
| `/workspace/extra/music_research` | `~/projects/music_research` | read-write |
